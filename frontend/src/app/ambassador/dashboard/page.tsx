          ...
          <div className="relative">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4 min-w-0">
              ...
              <button
                ...
                className="w-full md:w-auto bg-white text-purple-600 px-6 py-3 rounded-2xl font-bold hover:bg-gray-100 transition-all shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center gap-2 flex-shrink-0"
              >
